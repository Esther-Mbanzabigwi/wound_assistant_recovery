    ...
    <AppLayout>
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.recommendationsCard}>
          <Text style={styles.recommendationsTitle}>What this means</Text>
          <Text style={styles.recommendationsText}>
            Your wound appears to be {predictionData.result.toLowerCase()}. 
            Continue monitoring and follow your healthcare provider's advice.
          </Text>
        </View>
